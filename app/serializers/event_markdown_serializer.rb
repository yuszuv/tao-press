...
require_relative "markdown_serializer/transformations"

module Serializers
  class EventMarkdownSerializer < TaoPress::Serializer
    include Import['markdown_writer']

    Transformations = MarkdownSerializer::Transformations
